...
<head>
  ...
  <title>Majebul Tech PC Electronics Shop Contact US</title>
        ...
        <div id="contactdetailscontainer">
            <div class="contactdetails">
                ...
                <p class="grey-text text-lighten-4 bold" style="margin:8px;font-size:16px">
                    <strong class="grey-text text-lighten-4 bold" style="font-size:22px">Majebul Tech PC Electronics Shop Solutions (registered name)</strong><br>
                    GL-Road Gonapara, Gopalganj Sadar, Dhaka, Bangladesh.
                </p>
            </div>
            <div class="contactdetails">
                <div class="iconcontainer">
            ...
            <div class="contactdetails">
                ...
                <p class="grey-text text-lighten-4 bold" style="margin:8px;font-size:16px">
                    <strong class="grey-text text-lighten-4 bold" style="font-size:20px">Majebul Tech PC Electronics Shop Solutions</strong><br>
                    majabulislam527@gmail.com
                </p>
            </div>
            <div class="contactdetails">
                <div class="iconcontainer">
